...
c---------------------------------------------------------------------
     ...
     >   u_odd   (5,  -2:IMAX+1,-2:JMAX+1,-2:KMAX+1, maxcells),
     >   u_even  (5,  -2:IMAX+1,-2:JMAX+1,-2:KMAX+1, maxcells),
     ...
     >   u_copy  (5,  -2:IMAX+1,-2:JMAX+1,-2:KMAX+1, maxcells),
     >   u_copy2  (5,  -2:IMAX+1,-2:JMAX+1,-2:KMAX+1, maxcells)
      pointer(ptr_us, us)
      pointer(ptr_vs, vs)
      pointer(ptr_ws, ws)
      pointer(ptr_qs, qs)
