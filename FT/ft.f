...
c---------------------------------------------------------------------
     ...
     >             ptr_twiddle
      ...
      double precision   u0_copy(ntdivnp),
     >                   u1_copy(ntdivnp),
     >                   u2_copy(ntdivnp)

      pointer (ptr_u0_copy, u0_copy)
      pointer (ptr_u1_copy, u1_copy)
      pointer (ptr_u2_copy, u2_copy)
...
c      call c_openmp_init(4)
      call unimem_malloc(ptr_u0_copy, sizeof(u0_copy), data_pos)
      call unimem_malloc(ptr_u1_copy, sizeof(u1_copy), data_pos)
      call unimem_malloc(ptr_u2_copy, sizeof(u2_copy), data_pos)
...
c      call unimem_malloc(ptr_sums, sizeof(sums), data_pos)
      call unimem_malloc(ptr_sums, sizeof(sums), 1)
...
c      call unimem_malloc(ptr_twiddle, sizeof(twiddle), data_pos)
      ...
      print *,"sizeof(u0)", sizeof(u0)
      print *,"sizeof(u1)", sizeof(u1)
      print *,"sizeof(u2)", sizeof(u2)
      print *,"sizeof(sums)", sizeof(sums)
      print *,"sizeof(twiddle)", sizeof(twiddle)
...
c          call c_dram_cache_move(curr_rank)

c          call c_memcpy(ptr_u0_copy, ptr_u0, sizeof(u0))                                                                                         
c          call c_memcpy(ptr_u1_copy, ptr_u1, sizeof(u1))                                                                                         
c          call c_memcpy(ptr_u2_copy, ptr_u2, sizeof(u2))                                                                                         


c         call c_memmove_movnt(ptr_u0_copy, ptr_u0, sizeof(u0))                                                                                   
c         call c_memmove_movnt(ptr_u1_copy, ptr_u1, sizeof(u1))                                                                                   
c         call c_memmove_movnt(ptr_u2_copy, ptr_u2, sizeof(u2))
