...
c---------------------------------------------------------------------------c
     ...
     >                 r_copy(nr),r_copy2(nr)
      pointer(ptr_u, u)
      pointer(ptr_v, v)
      pointer(ptr_r, r)
      pointer(ptr_a, a)
      pointer(ptr_c, c)
      pointer(ptr_r_copy, r_copy)
      pointer(ptr_r_copy2, r_copy2)
...
c      call c_openmp_init(4)                                                                                                                     
      ...
      call unimem_malloc(ptr_r_copy, sizeof(r), data_pos)
      call unimem_malloc(ptr_r_copy2, sizeof(r), data_pos)
...
c         call begin_one_phase
   ...
   80       format('  iter ',i4)
         ...
         call resid(u,v,r,n1,n2,n3,a,k)
c---------------kai---------------------                                                        
c          call c_dram_cache_cp(ptr_r_copy, ptr_r, sizeof(r))
c          call c_dram_cache_move(ptr_r_copy, ptr_r, sizeof(r))
c         call c_memwrite(ptr_r_copy, sizeof(rnm2), sizeof(r_copy), 
c     >        curr_rank, 1)                                                                               
c         call c_memwrite(ptr_r_copy, sizeof(rnm2), sizeof(r_copy),
c     >        curr_rank, 2)  
         call c_memwrite(ptr_r_copy, sizeof(rnm2), sizeof(r_copy),
     >        curr_rank, 3)    
c         call c_memcpy(ptr_r_copy2, ptr_r, sizeof(r))
c         call c_memmove_movnt(ptr_r_copy2, ptr_r, sizeof(r))    
c---------------------------------
